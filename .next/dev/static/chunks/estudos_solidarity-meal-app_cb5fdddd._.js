...
function DoadorProvider({ children }) {
    _s();
    const [doador, setDoador] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$estudos$2f$solidarity$2d$meal$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "DoadorProvider.useState": ()=>{
    ...
    const carregarDoador = (email)=>{
        if ("TURBOPACK compile-time truthy", 1) {
            ...
            if (doadores) {
                const listaDoadores = JSON.parse(doadores);
...
_s(DoadorProvider, "fWsUQhfE2Q5jd31QRInSR7jSL58=");
_c = DoadorProvider;
function useDoador() {
    _s1();
    const context = (0, __TURBOPACK__imported__module__$5b$project$5d2f$estudos$2f$solidarity$2d$meal$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(DoadorContext);
    if (!context) {
        throw new Error("useDoador deve ser usado dentro de DoadorProvider");
    }
    return context;
}
_s1(useDoador, "b9L3QQ+jgeyIrH0NfHrJ8nn7VMU=");
var _c;
...
function BeneficiarioProvider({ children }) {
    _s();
    const [beneficiario, setBeneficiario] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$estudos$2f$solidarity$2d$meal$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "BeneficiarioProvider.useState": ()=>{
            if ("TURBOPACK compile-time truthy", 1) {
    ...
    const carregarBeneficiario = (email)=>{
        if ("TURBOPACK compile-time truthy", 1) {
            ...
            if (beneficiarios) {
                const listaBeneficiarios = JSON.parse(beneficiarios);
                const beneficiarioEncontrado = listaBeneficiarios.find((b)=>b.email.toLowerCase() === email.toLowerCase());
...
_s(BeneficiarioProvider, "UeVsxo06KXaDsVczI5t49P1l8No=");
_c = BeneficiarioProvider;
function useBeneficiario() {
    _s1();
    const context = (0, __TURBOPACK__imported__module__$5b$project$5d2f$estudos$2f$solidarity$2d$meal$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(BeneficiarioContext);
    if (!context) {
        throw new Error("useBeneficiario deve ser usado dentro de BeneficiarioProvider");
    }
    return context;
}
_s1(useBeneficiario, "b9L3QQ+jgeyIrH0NfHrJ8nn7VMU=");
var _c;
...
function AuthProvider({ children }) {
    _s();
    const [auth, setAuth] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$estudos$2f$solidarity$2d$meal$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
...
_s(AuthProvider, "zxBvm33rT6b5BDmSX5KhRaJq8HI=", false, function() {
    return [
...
//# sourceMappingURL=estudos_solidarity-meal-app_cb5fdddd._.js.map