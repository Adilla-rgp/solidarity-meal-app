      ...
      <div className="bg-white rounded-2xl shadow-lg p-8 w-full max-w-2xl">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-gray-500 text-center mt-2">
            Preencha seus dados para receber doações:
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          />
          {errors.nome && (
            <p className="text-red-500 text-sm -mt-4">{errors.nome}</p>
          )}
          ...
          />
          {errors.senha && (
            <p className="text-red-500 text-sm -mt-4">{errors.senha}</p>
          )}
          ...
          />
          {errors.telefone && (
            <p className="text-red-500 text-sm -mt-4">{errors.telefone}</p>
          )}
          ...
          />
          {errors.endereco && (
            <p className="text-red-500 text-sm -mt-4">{errors.endereco}</p>
          )}
          ...
          />
          {errors.necessidade && (
            <p className="text-red-500 text-sm -mt-4">{errors.necessidade}</p>
          )}
